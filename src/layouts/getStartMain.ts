...
import { setSavedDependencies } from '../features/setSavedDependencies';
...
export function getStartMain() {
    ...
    const mainSaved = localStorage.getItem('main-andrabaila');
    if (mainSaved && queryJson) {
        setSavedDependencies(main);
    } else {
